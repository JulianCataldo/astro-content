...
See the official [JSON Schema tutorial](https://json-schema.org/learn/getting-started-step-by-step.html).
...
See the [doc. sections](https://github.com/JulianCataldo/astro-content/tree/master/docs/content/docs) content for inspiration.
