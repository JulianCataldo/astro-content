// NOTE: From Remco Haszing: https://github.com/microsoft/monaco-editor/pull/3096
// This is not merged yet in monaco-editor.
...
// eslint-disable-next-line @typescript-eslint/consistent-type-assertions
export const language = <l.IMonarchLanguage>{
  defaultToken: '',
  tokenPostfix: '.mdx',
  control: /[!#()*+.[\\\]_`{}\-]/,
  escapes: /\\@control/,
